...
export default function IssueManagement() {
    ...
    const filteredTickets = tickets.filter(t => {
        ...
        if (searchErp && !t.entered_erp.toLowerCase().includes(searchErp.toLowerCase())) return false;
        return true;
    });
                                ...
                                <TableRow key={ticket.id}>
                                    ...
                                    <TableCell>
                                        <div className="flex flex-col">
                                            <span className="font-medium">{ticket.roster_name || 'Unknown'}</span>
                                            ...
                                            <SheetContent>
                                                ...
                                                <div className="space-y-6 mt-6">
                                                    <div>
                                                        ...
                                                        <p>{ticket.roster_name} ({ticket.entered_erp})</p>
